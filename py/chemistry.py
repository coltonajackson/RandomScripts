...
def make_periodic_table(chemical_formula):
    periodic_table_dict = {
    ...
    for key in periodic_table_dict:
        if key in chemical_formula:
            new_periodic_table[key] = periodic_table_dict[key]
    return new_periodic_table
...
def main():
    ...
    mass_chem_sample = float(input("Enter mass chemical sample in grams: "))

    # Call the make_periodic_table function and
    # store the periodic table in a variable.
    periodic_table_dict = make_periodic_table(chemical_formula)
